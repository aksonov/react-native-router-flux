...
import ReduxEngine, { navMiddleware, navReducer } from 'react-native-router-flux/src/Engines/ReduxEngine';
import { Router, Reducer, Scene, Actions, ActionConst, Overlay, Tabs, Modal, Drawer, Stack, Lightbox } from 'react-native-router-flux';
...
export default class ExampleRedux extends Component {
  render() {
    return (
      <Provider store={store}>
        <Router engine={ReduxEngine(store)} createReducer={reducerCreate} tintColor="red" getSceneStyle={getSceneStyle}>
          <Overlay>
