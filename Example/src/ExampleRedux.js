...
const navReducer = new Reducer();
const reduxStore = createStore(
  combineReducers({
    nav: (state, action) => navReducer(state, action) || state || null,
  })
);
...
class ExampleConnected extends React.Component {
  render() {
    return (
      <Example
...
const ConnectedExample = connect(mapStateToProps)(ExampleConnected);
