...
state=(0,_State.getActiveState)(newState);if(!(

(0,_lodash2.default)(state.params,_this3.currentParams)&&state.routeName===_this3.currentScene)){_context.next=5;break;}return _context.abrupt('return');case 5:
...
};}_createClass(NavigationStore,[{key:'setupEngine',value:function setupEngine(engine){engine.stateManager.setupHandlers(this.nextState,this.setState,_State.getActiveState);this.engineDispatch=engine.stateManager.dispatch;}}]);return NavigationStore;}();exports.default=
