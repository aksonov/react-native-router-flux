...
| `swipeEnabled`     | `boolean` | `true` | Enable or disable swiping tabs on Android. |
| `animationEnabled`     | `boolean` | `true` | Enable or disable animating tabs on switch on Android. |
